...
const DopplerEffectColors = {
  ...
  // Graph colors
  graphBackgroundColorProperty: new ProfileColorProperty(dopplerEffect, "graphBackgroundColor", {
  ...
  controlPanelBackgroundColorProperty: new ProfileColorProperty(dopplerEffect, "controlPanelBackgroundColor", {
    default: new Color(50, 50, 50),
    projector: new Color(238, 238, 238),
  }),
  controlPanelBorderColorProperty: new ProfileColorProperty(dopplerEffect, "controlPanelBorderColor", {
    default: new Color(150, 150, 150),
    projector: new Color(210, 210, 210),
  }),
  controlPanelTextColorProperty: new ProfileColorProperty(dopplerEffect, "controlPanelTextColor", {
    default: WHITE,
    projector: BLACK,
  }),

  // Velocity arrow colors
  sourceVelocityArrowColorProperty: new ProfileColorProperty(dopplerEffect, "sourceVelocityArrowColor", {
    default: new Color(100, 255, 100), // Green to match source
    projector: new Color(0, 200, 0), // Darker green for projector
  }),
  observerVelocityArrowColorProperty: new ProfileColorProperty(dopplerEffect, "observerVelocityArrowColor", {
    default: new Color(180, 50, 255), // More vibrant purple to match observer
    projector: new Color(120, 0, 180), // Deeper purple for projector
  }),

  // Grid colors
  gridMajorLineColorProperty: new ProfileColorProperty(dopplerEffect, "gridMajorLineColor", {
    default: new Color(120, 120, 120), // Medium gray for default
    projector: new Color(80, 80, 80), // Darker gray for projector
  }),
  gridMinorLineColorProperty: new ProfileColorProperty(dopplerEffect, "gridMinorLineColor", {
